...
.ham-btn{
  ...
  gap:5px;flex-shrink:0;transition:all .2s;margin-right:4px;
}
.ham-btn span{display:block;width:16px;height:1.5px;background:var(--t2);border-radius:2px;transition:all .25s}
.ham-btn:hover{border-color:rgba(200,255,71,0.3);background:rgba(200,255,71,0.06)}
.ham-btn:hover span{background:var(--a)}
...
@media(max-width:900px){
  ...
  .tb{height:52px;padding:0 16px}
  .tb-r .sys-pill{display:none}
  .chat{padding:16px 14px;gap:3px}
  .inp-zone{padding:10px 14px 16px}
  .qbar{padding:7px 14px}
  .e-title{font-size:44px}
...
@media(max-width:540px){
  .tb{height:50px;padding:0 12px}
  .tb-title{font-size:14px}
  .tb-sub{font-size:7px}
  .tb-btn{padding:5px 10px;font-size:8px}
  .tb-ic{width:30px;height:30px;font-size:14px}

  .qbar{padding:6px 12px;gap:5px}
  .q-btn{font-size:9px;padding:4px 10px}

  .chat{padding:12px 10px;gap:2px}

  .e-orb{width:56px;height:56px;font-size:22px}
  .e-title{font-size:34px;margin-bottom:6px}
  .e-cmd{font-size:8px;padding:4px 10px}
  .e-sub{font-size:11px;margin-bottom:18px}
  .e-grid{grid-template-columns:repeat(2,1fr);gap:6px}
  .e-card{padding:11px 10px}
  .e-ic{font-size:17px;margin-bottom:6px}
  .e-name{font-size:9.5px}
  .e-hint{font-size:7.5px}
  .e-chip{font-size:9.5px;padding:5px 11px}

  .msg{gap:8px;padding:8px 0}
  .av{width:26px;height:26px;font-size:9px;border-radius:7px}
  .msg-body{max-width:94%}
  .bub{font-size:11.5px;padding:10px 13px;border-radius:12px}
  .msg-meta{font-size:7px}

  /* weather card */
  .w-temp{font-size:52px}
  .w-emoji{font-size:38px}
  .w-grid{grid-template-columns:repeat(2,1fr)}
  .w-city{font-size:12px}
  .w-cond{font-size:9px}

  /* crypto card */
  .c-grid{grid-template-columns:1fr}
  .c-price{font-size:20px}

  /* db table — make it scroll on small screens */
  .card-b{padding:10px 12px;overflow-x:auto}
  .db-tbl{min-width:340px}

  /* calc / converter */
  .res-val{font-size:42px}

  /* input zone */
  .inp-zone{padding:8px 10px 14px}
  .inp-wrap{padding:3px 3px 3px 13px;border-radius:14px}
  .inp-wrap textarea{font-size:12px;padding:9px 0}
  .send,.mic-btn{width:33px;height:33px;border-radius:8px}
  .inp-hint{font-size:8px}
  kbd{font-size:6.5px;padding:1px 4px}

  /* sidebar stats at bottom */
  .sb-stat-n{font-size:22px}
  .sb-mdl-n{font-size:10.5px}
}
</style>
</head>
<body>
...
<main class="main">
  <header class="tb">
    <div class="tb-l">
      <button class="ham-btn" onclick="toggleSidebar()" aria-label="Toggle menu">
...
// Close sidebar after agent switch on mobile
const _origSwitch=switchAgent;
window.switchAgent=function(key){_origSwitch(key);if(window.innerWidth<=900)closeSidebar();}
</script>
</html>"""
