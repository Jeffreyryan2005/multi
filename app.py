...
.sb-logo{font-family:var(--display);font-size:36px;color:#fff;line-height:.95;letter-spacing:.02em}
...
.sb-stat-n{font-family:var(--display);font-size:28px;color:#fff;line-height:1}
...
.tb-title{font-family:var(--display);font-size:20px;color:#fff;letter-spacing:.04em;line-height:1;transition:all .2s}
...
.e-title{font-family:var(--display);font-size:56px;color:#fff;letter-spacing:.05em;line-height:.9;margin-bottom:4px}
...
.card-h-t{font-family:var(--display);font-size:14px;color:var(--t1);letter-spacing:.08em;flex:1}
...
.w-temp{font-family:var(--display);font-size:64px;color:#fff;line-height:1;text-shadow:0 0 40px rgba(200,255,71,0.2)}
...
.n-num{font-family:var(--display);font-size:22px;color:rgba(255,255,255,0.15);min-width:24px;line-height:1;margin-top:1px}
...
.c-price{font-family:var(--display);font-size:22px;color:#fff;line-height:1}
...
.res-val{font-family:var(--display);font-size:52px;color:var(--a);text-shadow:0 0 30px rgba(200,255,71,0.3);line-height:1}
